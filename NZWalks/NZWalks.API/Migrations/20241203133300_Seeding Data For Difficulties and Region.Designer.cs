...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20241203133300_Seeding Data For Difficulties and Region")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NZWalks.API.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8bc40787-63f6-4e4e-a25b-aaffc477f0f5"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("801c1f38-66b1-4092-90a8-c2c94e0c712f"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("e9feedff-0956-4ad6-a719-9ebecdf68f39"),
                            Name = "Hard"
                        });
                });
            ...
            modelBuilder.Entity("NZWalks.API.Models.Domain.Walk", b =>
                {
                    b.HasOne("NZWalks.API.Models.Domain.Difficulty", "Difficalty")
                        .WithMany()
